...
| Task Name            | Description                                                          | Estimated hrs | Actual hrs |
| :------------------- | :------------------------------------------------------------------- | :------------ | :--------- |
| Extractor \- Filter1 | Creating the first rule-based claim extraction filter                | 5hrs          | 7hrs       |
| Triplet Extractor    | Extracts key info from claims into subject-object-predicate triplets | 3hrs          | 5hrs       |
| QA                   | Creating and running tests for all components                        | 5hrs          | 10hrs      |
| SRS                  | Create SRS document                                                  | 2hrs          | 4hrs       |
| Presentation 1       | Create progress presentation and script                              | 2hrs          | 3hrs       |
| Final Presentation   | Create final presentation and script                                 | 3hrs          | 4hrs       |
| Final Report         | Create final report                                                  | 5hrs          | 6hrs       |
| Research             | Research on tools to be used                                         | 2hrs          | 4hrs       |

**John**

| Task Name                       | Description                                                                                                                      | Estimated hrs | Actual hrs |
| :------------------------------ | :------------------------------------------------------------------------------------------------------------------------------- | :------------ | :--------- |
| Helper Tools                    | Wikipedia scraper, SQLite DB set up, text2doc converter, model builder, text categorizer, Search engine APIs…                    | 6hrs          | 10hrs      |
| Filter2                         | Creates SVM model trained on ClaimBuster Dataset                                                                                 | 5hrs          | 7hrs       |
| Verifier                        | Create search prompt generator to gather evidence using google’s API then use Hugging face pretrained model to generate a score. | 10hrs         | 8hrs       |
| Chrome extension                | Make a simple chrome extension with simple UI                                                                                    | 1hr           | 4hrs       |
| Backend                         | Make API using FASTAPI, connect extractor and verifier into a single pipeline.                                                   | 1hr           | 3hr        |
| Presentations/SRS/Final Reports | Help Foster in making the presentation and documents                                                                             | 1hr           | 2hrs       |
| Small Tasks                     | e.g. Setting up github/Util functions… small tasks..                                                                             | 3hrs          | 5hrs       |
